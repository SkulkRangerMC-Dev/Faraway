package com.sculkrange.faraway.worldgen.biomes;
...
public class FarawayBiomes {
    public static final ResourceKey<Biome> TEST_BIOME = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(Faraway.MOD_ID, "test_biome"));

    public static void boostrap(BootstapContext<Biome> context) {
        context.register(TEST_BIOME, IcyPlains(context));
    }
    ...
    public static Biome IcyPlains(BootstapContext<Biome> context) {
