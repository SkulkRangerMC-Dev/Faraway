package com.sculkrange.faraway.worldgen.dimension;

import com.mojang.datafixers.util.Pair;
import com.sculkrange.faraway.Faraway;
import com.sculkrange.faraway.worldgen.biomes.FarawayBiomes;
...
public class FarawayWorlds {
    ...
    public static final ResourceKey<DimensionType> KAUPEN_DIM_TYPE = ResourceKey.create(Registries.DIMENSION_TYPE,
            new ResourceLocation(Faraway.MOD_ID, "kaupendim_type"));
    ...
    public static void bootstrapStem(BootstapContext<LevelStem> context) {
        ...
        NoiseBasedChunkGenerator wrappedChunkGenerator = new NoiseBasedChunkGenerator(
                new FixedBiomeSource(biomeRegistry.getOrThrow(FarawayBiomes.TEST_BIOME)),
                noiseGenSettings.getOrThrow(NoiseGeneratorSettings.AMPLIFIED));

        NoiseBasedChunkGenerator noiseBasedChunkGenerator = new NoiseBasedChunkGenerator(
                MultiNoiseBiomeSource.createFromList(
                        new Climate.ParameterList<>(List.of(Pair.of(
                                        Climate.parameters(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F), biomeRegistry.getOrThrow(FarawayBiomes.TEST_BIOME)),
                                Pair.of(
        ...
        LevelStem stem = new LevelStem(dimTypes.getOrThrow(com.sculkrange.faraway.worldgen.dimension.FarawayWorlds.KAUPEN_DIM_TYPE), noiseBasedChunkGenerator);
